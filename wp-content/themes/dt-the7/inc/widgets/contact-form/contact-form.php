	...
	function widget( $args, $instance ) {
		...
		if ( $fields_not_empty ) {
			...
			if ( $instance['terms'] ) {
				...
				printf(
				    '<p><input type="checkbox" id="%1$s" name="terms" class="validate[required] the7-form-terms" aria-required="true" />&nbsp;<label for="%1$s"><span class="form-terms-text">%2$s</span></label></p>',
                    $terms_field_id,
